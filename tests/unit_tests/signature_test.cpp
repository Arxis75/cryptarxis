...
TEST(SignatureTests, Micah_verify_vectors)
{
    ...
    Signature sig( ByteStream("433EC3D37E4F1253DF15E2DEA412FED8E915737730F74B3DFB1353268F932EF5", 32, 16),
    ...
    sig = Signature( ByteStream("45CEA25D72DB4929DC27BC66527BBB215D20E323FF0DE944640930BE5C38C534", 32, 16),
    ...
    x = ByteStream("1", 32, 16);
    sig = Signature( ByteStream("1", 32, 16),
                     ByteStream("1", 32, 16),
                     true );
    expected = false;
    actual = sig.isValid(t_h, x.getPubKey().getAddress());
